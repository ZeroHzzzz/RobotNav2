...
def generate_launch_description():
    ...
    declare_robot_sdf_cmd = DeclareLaunchArgument(
        'robot_sdf',
        default_value=os.path.join(bringup_dir, 'worlds', 'robot.sdf'),
    ...
    start_gazebo_cmd = ExecuteProcess(
        cmd=['gz', 'sim', '--verbose', world, '-s', 'libgazebo_ros_init.so', '-s', 'libgazebo_ros_factory.so'],
        cwd=[launch_dir], output='screen')
    ...
    urdf = os.path.join(bringup_dir, 'urdf', 'fishbot_base.urdf')
